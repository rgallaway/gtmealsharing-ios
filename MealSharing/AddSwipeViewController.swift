...
class AddSwipeViewController: UITableViewController {
    ...
    @IBOutlet weak var location1Cell: UITableViewCell!
    @IBOutlet weak var location2Cell: UITableViewCell!
    @IBOutlet weak var location3Cell: UITableViewCell!
    @IBOutlet weak var location4Cell: UITableViewCell!
